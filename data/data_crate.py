...
def create_data(num_bits, num_samples, max_number, numbers_to_divide_by: list, modules: list) -> pd.DataFrame:
    """
    ...
    try:
        ...
        print(f"loaded data from file data_max_{max_number}_sample_{num_samples}_first_divider_{numbers_to_divide_by}.csv")
        return df
    except FileNotFoundError:
        print(f"could not find file data_max_{max_number}_sample_{num_samples}_first_divider_{numbers_to_divide_by}.csv")
